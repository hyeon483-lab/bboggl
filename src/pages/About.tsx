...
export default function About() {
  useDocumentMeta({
    title: '소개 | Analysis10k',
    description: 'Analysis10k이 어떤 사이트인지, 데이터를 어떻게 만드는지 소개합니다.',
  });

  return (
    <div className={styles.page}>
      <h1 className={styles.title}>Analysis10k 소개</h1>

      <section className={styles.section}>
        <p>
          Analysis10k은 미국 상장기업의 공시자료(10-K)를 바탕으로, 복잡한 재무제표를 몇 분 안에 이해할 수
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          현재 33개 기업의 분석이 올라와 있고, 다른 기업들도 순차적으로 채워나가고 있어요.
        </p>
      ...
      <section className={styles.section}>
        <h2>투자 관련 안내</h2>
        <p>
          Analysis10k의 콘텐츠는 정보 제공 목적일 뿐 투자 권유가 아니에요. 투자 판단과 그 결과에 대한 책임은
